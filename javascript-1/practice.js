...
// function greeterMethod(name, state){
// 	// let name = me.firstName
// 	// let state = me.state
// 	return `Hello! My name is${name}and I live in${state}`
// }
...
// Code Here
const forTheLoveOfGeorge = notGeorge.map(function(str) {
	if(str !=="George") {
		return str = "George"
	}
})
...
// Code Here
function isEnemy(arr) {
	if(people.friend !== true)
	return arr
}

const enemies = people.filter(isEnemy) 
...
const awesomeCallback = (acc, curr) => people.awesomeLevel()

const totallyAwesome = people.reduce(awesomeCallback =>
	acc = acc + curr)

//Tried a bunch of stuff but I'm moving on. I know what I have is a mess.